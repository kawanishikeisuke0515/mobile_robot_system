...
#include "zed_interfaces/msg/detail/zed_heading__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_interfaces::msg::ZedHeading & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_interfaces::msg::ZedHeading & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_interfaces
max_serialized_size_ZedHeading(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_interfaces::msg::ZedHeading;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_interfaces
max_serialized_size_key_ZedHeading(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const zed_interfaces::msg::ZedHeading *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_interfaces::msg::ZedHeading *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ZedHeading__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zed_interfaces::msg::ZedHeading *>(
...
static size_t _ZedHeading__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ZedHeading(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ZedHeading__callbacks = {
  "zed_interfaces::msg",
  "ZedHeading",
...
static rosidl_message_type_support_t _ZedHeading__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ZedHeading__callbacks,
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_ZedHeading__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, ZedHeading)() {
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_ZedHeading__handle;
}
